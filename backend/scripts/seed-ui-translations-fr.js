...
const entries = {
  ...
  'header.langSwitcherAria': 'Sélecteur de langue',
  'header.langPickerLabel': 'Langue',
  'header.lang.nl': 'Néerlandais',
  'header.lang.fr': 'Français',
  'header.lang.en': 'Anglais',
  'header.logoAlt': 'Logo Taxiofany',
  'header.accountRegionAria': 'Compte',
  'header.myAccountMenu': 'Menu de mon compte',
  'header.myAccount': 'Mon compte',
  'header.clientLogin': 'Se connecter',
  'header.userMenu.dashboard': 'Tableau de bord',
  'header.userMenu.newBooking': 'Nouvelle réservation',
  'header.userMenu.myTrips': 'Mes trajets',
  'header.userMenu.profile': 'Profil',
  'header.userMenu.security': 'Sécurité',
  ...
  'booking.package.handicap': 'Transport des personnes à mobilité réduite (PMR)',
  ...
  'booking.status.in-progress': 'En cours',
  'account.loginTitle': 'Connectez-vous à votre compte',
  'account.loginSubtitle': 'Utilisez votre email et mot de passe pour continuer.',
  'account.emailPlaceholder': 'Adresse email',
  ...
  'account.createOne': 'Créer un compte',
  'account.registerTitle': 'Créez votre compte',
  'account.registerSubtitle': 'Inscrivez-vous pour gérer vos réservations et trajets.',
  'account.fullNamePlaceholder': 'Nom complet',
  'account.phonePlaceholder': 'Numéro de téléphone',
  'account.passwordHint': 'Utilisez au moins 8 caractères pour renforcer votre compte.',
  ...
  'account.forgotPasswordLead':
    'La réinitialisation en ligne n’est pas encore disponible. Contactez notre équipe et nous vous aiderons à récupérer l’accès.',
  'account.forgotPasswordWhatsappText': 'Bonjour, j’ai besoin d’aide pour réinitialiser mon mot de passe.',
  'account.forgotPasswordWhatsappInfo':
    'Utilisez WhatsApp pour contacter un administrateur avec un message prérempli.',
  'account.contactWhatsapp': 'Contacter un administrateur sur WhatsApp',
  'account.forgotPasswordNoWhatsapp':
    'Le support WhatsApp n’est pas configuré. Utilisez la page contact avec votre email de compte.',
  'account.goToContact': 'Aller à la page contact',
  'account.backToLogin': 'Retour à la connexion',
  'account.logout': 'Se déconnecter',
  'account.portalNav': 'Navigation du compte',
  'account.portal.dashboard': 'Tableau de bord',
  'account.portal.newBooking': 'Nouvelle réservation',
  'account.portal.myTrips': 'Mes trajets',
  'account.portal.profile': 'Profil',
  'account.portal.security': 'Sécurité',
  'account.overview': 'Aperçu',
  'account.recentRides': 'Demandes de trajet récentes',
  'account.tripId': 'ID trajet',
  'account.route': 'Trajet',
  'account.date': 'Date',
  'account.status': 'Statut',
  'account.viewAllTrips': 'Voir tous les trajets',
  'account.profile': 'Profil',
  'account.name': 'Nom',
  'account.email': 'Email',
  'account.role': 'Rôle',
  'account.bookRide': 'Réserver une course',
  'account.support': 'Assistance',
  'account.myTripsTitle': 'Mes trajets',
  'account.tripsSubtitle': 'Suivez vos dernières demandes de réservation.',
  'account.tripsFor': 'Trajets de',
  'account.noTrips': 'Aucun trajet pour le moment.',
  'account.passwordTitle': 'Paramètres de sécurité',
  'account.passwordSubtitle': 'Mettez à jour le mot de passe de votre compte.',
  ...
  'account.profileSubtitle': 'Vos informations de compte lors de votre dernière connexion.',
  'account.profileDetails': 'Informations du compte',
  'account.profileSecurityBlurb': 'Sécurité',
  'account.profileSecurityText': 'Pour changer votre mot de passe, utilisez la section Sécurité.',
  ...
  'home.services.handicapTransport': 'Transport des personnes à mobilité réduite (PMR)',
  ...
  'pages.users.bookings.book-taxi.get_your_cab': 'Demandez votre course',
  'pages.users.bookings.book-taxi.book_your': 'Réservez votre',
  'pages.users.bookings.book-taxi.ride': 'trajet',
  'pages.users.bookings.book-taxi.everything_your_taxi_business':
    'Planifiez transport PMR, professionnel ou régulier en ligne',
  'pages.users.bookings.book-taxi.needs_is_already_here': 'avec un formulaire simple.',
  'pages.users.bookings.book-taxi.book_your_taxi': 'Demander votre taxi',
  'pages.users.bookings.details.booking_details': 'Détails de la réservation',
  'pages.users.bookings.details.your_ride_request_has_been_received_and_is_now_v':
    'Votre demande de trajet a bien été reçue et est visible par la répartition.',
  'pages.users.bookings.details.customer': 'Client',
  'pages.users.bookings.details.email': 'Email',
  'pages.users.bookings.details.pickup': 'Départ',
  'pages.users.bookings.details.destination': 'Destination',
  'pages.users.bookings.details.package': 'Forfait',
  'pages.users.bookings.details.passengers': 'Passagers',
  'pages.users.bookings.details.requested_date': 'Date demandée',
  'pages.users.bookings.details.requested_time': 'Heure demandée',
  'pages.users.bookings.details.status': 'Statut',
  'pages.users.bookings.create.create_booking': 'Créer une réservation',
  'pages.users.emails.list.email_library': 'Bibliothèque des emails',
  'pages.users.emails.list.published': 'Modèles',
  'pages.users.emails.list.email_templates': 'publiés',
  'pages.users.emails.list.preview_the_currently_published_customer_and_ope':
    'Prévisualisez les messages clients et opérations publiés depuis l’admin.',
  'pages.users.emails.list.no_published_email_templates_are_available_yet':
    'Aucun modèle email publié pour le moment.',
  'pages.users.emails.details.this_email_template_is_not_available':
    'Ce modèle email n’est pas disponible.',
  'pages.users.emails.details.template_summary': 'Résumé du modèle',
  'pages.users.emails.details.audience': 'Public :',
  'pages.users.emails.details.category': 'Catégorie :',
  'pages.users.emails.details.tone': 'Ton :',
  'pages.users.emails.details.status': 'Statut :',
  'emails.category.email': 'Email',
  'emails.category.general': 'Général',
  'emails.list.previewCta': 'Prévisualiser le modèle',
  'emails.details.notFoundTitle': 'Modèle introuvable',
  'emails.details.notFoundForSlug': 'Aucun modèle publié n’est disponible pour ce slug.',
  'emails.template.bodyTitle': 'Contenu du message',
  'emails.status.published': 'Publié',
  'emails.status.draft': 'Brouillon',
  'pages.users.profile.profile': 'Profil',
  ...
  'package.standard.summary': 'Courses quotidiennes confortables pour les trajets urbains.',
  'package.standard.priceLabel': 'Idéal pour les trajets quotidiens',
  'package.standard.feature.0': 'Chauffeur professionnel',
  'package.standard.feature.1': 'Prise en charge en ville',
  'package.standard.feature.2': 'Tarif transparent',
  'package.business.summary': 'Transport prioritaire pour réunions et agendas professionnels.',
  'package.business.priceLabel': 'Pour équipes et dirigeants',
  'package.business.feature.0': 'Planification prioritaire',
  'package.business.feature.1': 'Véhicules confort',
  'package.business.feature.2': 'Support entreprise',
  'package.vip.summary': 'Courses premium avec confort élevé et service dédié.',
  'package.vip.priceLabel': 'Expérience premium',
  'package.vip.feature.0': 'Véhicule premium',
  'package.vip.feature.1': 'Assistance dédiée',
  'package.vip.feature.2': 'Confort supplémentaire',
  ...
  'testimonial.default.1.quote':
    'Un transport fiable exactement au bon moment. La réservation était simple et le chauffeur très professionnel.',
  'testimonial.default.1.name': 'Eredrik Johanson',
  'testimonial.default.1.company': 'Financial INC',
  'testimonial.default.2.quote':
    'Taxiofany a rendu notre transfert aéroport simple, confortable et ponctuel. Je recommande pour les trajets professionnels et familiaux.',
  'testimonial.default.2.name': 'Mauricio Fernández',
  'testimonial.default.2.company': 'Voyageur professionnel',
  'testimonial.default.3.quote':
    'Véhicules propres, chauffeurs aimables et communication claire du départ à l’arrivée. C’est désormais mon service taxi préféré.',
  'testimonial.default.3.name': 'Javier F. Arébalo',
  'testimonial.default.3.company': 'Client local',
  ...
  'tag.belgium': 'Belgique',
  'tag.wheelchair': 'Fauteuil roulant',
  'tag.dispatch': 'Répartition',
  'tag.tflex': 'TFlex',
  'tag.mutuelle': 'Mutuelle',
  'tag.safety': 'Sécurité',
  'tag.training': 'Formation',
  'tag.hospital': 'Hôpital',
  'tag.care': 'Soins',
  'tag.business': 'Affaires',
  'tag.taxi': 'Taxi',
  'tag.policy': 'Réglementation',
  'tag.airport': 'Aéroport',
  'tag.brussels': 'Bruxelles',
  'tag.luggage': 'Bagages',
  'tag.caregiver': 'Aidant',
  'tag.family': 'Famille',
